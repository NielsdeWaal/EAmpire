...
class Enemy_a : public Enemy {
  ...
  public:
    ...
    * @brief Constructor
    *
    * When this constructor is called, it will make a custom circle shaped
    * enemy.
    ...
    * lives.
    * @param[in] speed			The speed with which the enemy
    * moves.
    * @param[in] lives			The lives of the enemy.
    * @param[in] diameter		The diameter for the circle
    * shape.
    */
    Enemy_a(sf::Vector2f start_position, const sf::Color color,
            const int damage, const int speed, int lives, const float diameter);
    ...
    */
    ...
    /**
    * @brief Function for coloring the shape of the enemy when hovering over it
    * with your mouse.
    *
