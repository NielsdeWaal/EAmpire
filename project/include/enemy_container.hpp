...
class Enemy_container {
  ...
  public:
    ...
    *
    * If this constructor is called, it will make the map with the count at
    * zero.
    */
    ...
    *
    * The pointer will be erased from the std::map, thereafter the Enemy will be
    * destructed.
    *
    * @param[in]	index	To locate which enemy pointer has to be
    * removed
    */
