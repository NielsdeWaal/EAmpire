...
* @date 31/1/18
*
* @brief Class to handle images loaded from a file (now mostly used for cutscenes)
*
...
public:
    ...
    *
    * This function sets the position of the image, and draws it using the window.draw() method from SFML
    *
