...
class action {
  ...
  public:
    ...
    * @param[in] work		A function pointer to a void function (usually
    * lambda) - this function will be executed when the above function returns
    * true
    **/
    ...
    * @param[in] work		A function pointer to a void function (usually
    * lambda) - this function will be executed when the above key is pressed
    **/
    ...
    * @param[in] work		A function pointer to a void function (usually
    * lambda) - this function will be executed when the above button is clicked
    **/
    action(sf::Mouse::Button button, std::function<void()> work);

    /**
    * @brief Overloaded operator() to make it possible to execute functions
