...
class Enemy {
  ...
  protected:
    ...
    // The text that represents the lives of the enemy when you hovering over it
    // with your mouse
    // sf::Text text;
  public:
    /**
    ...
    */
    Enemy(sf::Vector2f start_position, sf::Color color, const int damage,
          const int speed, int lives)
        : position(start_position), color(color), damage(damage), speed(speed),
          lives(lives) {
    }
    ...
    * instead of the distance to the player. use the result to move your enemy.
    *
    * @param[in]	location	The location where the enemy has to move
    * to.
    * @return		bool		when the enemy arrives at the location, true is
    ...
    */
    ...
    /**
    * @brief Virtual function for coloring the shape of the enemy when hovering
    * over it with your mouse.
    *
    * @param[in]	color		The color that must take the shape of the
    * enemy
    */
    ...
    // NOT FINISHED: because it is a feature
    /**
    * @brief Function for drawing the info of the enemy when hovering over it
    * with your mouse.
    *
    * @param[out] Window                the screen on which you have to draw.
    * @param[in]  Position              of the enemy to center the text of 
